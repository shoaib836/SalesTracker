...
const TLV = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        const storedMonths = await AsyncStorage.getItem('@tlv_months');
  ...
  //     await AsyncStorage.removeItem('@tlv_months');
  //     await AsyncStorage.setItem(
  //       '@tlv_months',
  //       JSON.stringify(defaultMonths),
  //     );
  ...
  const saveEntries = async () => {
    ...
    try {
      ...
      await AsyncStorage.setItem('@tlv_months', JSON.stringify(updatedMonths));
    } catch (error) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>TheLeatherValley</Text>
        <View style={{ width: 24 }} />
      </View>
